  ...
  return (
    <Page title="Dashboard">
      <Container maxWidth="xl">
        ...
        <Typography variant="h4" sx={{ mb:3, mt:3 }}>Assignments</Typography>
        ...
        <Typography variant="h4" sx={{ mb:3, mt:3 }}>Course Material</Typography>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6} md={3} lg={4}>
            {<iframe src = { 'https://www.youtube.com/embed/h7MYJghRWt0' } 
            frameBorder="0"
          ...
          <Grid item xs={12} sm={6} md={3} lg={4}>
            {<iframe src = { 'https://www.youtube.com/embed/fKopy74weus' } 
              frameBorder="0"
              allow="accelometer; autoplay; encrypted-media"
              allowFullScreen 
              title="UseState" />}
          ...
          <Grid item xs={12} sm={6} md={3} lg={4}>
            {<iframe src = { 'https://www.youtube.com/embed/aPfkYu_qiF4' } 
              frameBorder="0"
              allow="accelometer; autoplay; encrypted-media"
              allowFullScreen 
              title="UseEffect" />}
